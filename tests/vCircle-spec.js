define(function(require) {
  ...
  var circles = require('vCircle');

  describe('Circles', function() {
    it("is defined", function() {
        expect(typeof Circles).to.be('function');
    });
    ...
    describe('#create', function() {
        ...
        it("returns a Circles instance", function() {
            ...
            expect(circles instanceof Circles).to.be(true);
        });
        ...
        it("generates the SVG without animation", function() {
            ...
            expect(element.innerHTML).to.be(expected);
        });
        ...
        it("adds the supplied text", function() {
            ...
            expect(element.innerHTML.indexOf('<span class="circles-text">%</span>') > 0).to.be(true);
        });
    });
